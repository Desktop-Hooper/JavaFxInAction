...
public class RainOfMoney extends Application
{
    ...
    public void start(Stage theStage)
    {
        ...
        briefcase.setImage(new Image(RainOfMoney.class.getResourceAsStream("briefcase.png")));
        ...
        for (int i = 0; i < 15; i++)
        {
            ...
            moneybag.setImage(new Image(RainOfMoney.class.getResourceAsStream("moneybag.png")));
        ...
        new AnimationTimer()
        {
            public void handle(long currentNanoTime)
            {
                ...
                String pointsText = "装袋的现金: ￥" + (100 * score.value);
                gc.setFont(Font.font("Arial", FontWeight.NORMAL, 15));
                gc.fillText( pointsText, 280, 36 );
                gc.strokeText( pointsText, 280, 36 );
            }
        }.start();
